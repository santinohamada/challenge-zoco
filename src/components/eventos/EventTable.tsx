...
export default function EventTable({ eventos, onDeleteRequest, onEdit }: EventTableProps) {
  if (eventos.length === 0) {
    return (
                  ...
                  <td className="p-4 px-6 align-middle text-right">
                    <div className="flex items-center justify-end gap-1">
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium text-zinc-700 transition-all hover:bg-zinc-100 hover:text-zinc-900"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium text-red-500 transition-all hover:bg-red-50 hover:text-red-700"
                      >
                        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
