        ...
        <table className="w-full caption-bottom text-sm">
          <thead className="[&_tr]:border-b">
            <tr className="border-b transition-colors hover:bg-muted/50">
              ...
              <th className="h-12 px-4 text-left align-middle font-medium text-muted-foreground">Lugar</th>
          ...
          <tbody className="[&_tr:last-child]:border-0">
            {eventos.map((evento) => (
              <tr key={evento.id} className="border-b transition-colors hover:bg-muted/50">
